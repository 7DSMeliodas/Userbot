...
#PinSilent
@BOT.on_message(Filters.regex("^#players: (\d+)") & Filters.chat('Ethiowerewolf') & Filters.chat('-1001280664204') & ~Filters.edited)
...
#PinWithNotification
@BOT.on_message(Filters.regex("^#players: (\d+)") & Filters.chat('themightypack') & Filters.chat('lightwerewolf') & ~Filters.edited)
